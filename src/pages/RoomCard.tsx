...
import { ManageHiveModal } from "./ManageHiveModal";
...
export function RoomCard({ room, onJoin, onUpdateRoom }: RoomCardProps) {
  const [isManageModalOpen, setIsManageModalOpen] = useState(false);
  const isPrivate = room.type === "private";
  const isFull = room.usersInside >= room.maxUsers;
  const isAdministrator = room.userRole === "administrator";
      ...
      <div className="bg-white border border-zinc-200 rounded-2xl overflow-hidden hover:shadow-xl hover:shadow-zinc-900/5 transition-all group">
        ...
        <div className="p-5">
          ...
          <div className="flex items-center gap-2 mb-4">
            ...
            {room.userRole === "supervisor" && (
              <span className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-blue-50 text-blue-700 rounded-md text-xs">
